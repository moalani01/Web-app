...
export const MESSAGE_TYPES: MessageType[] = [
  {
    ...
    fields: [
      { 
        ...
        label: 'Sensor Type', 
        type: 'dropdown', 
        options: ['Temperature', 'Humidity', 'Pressure', 'Light'], 
        required: true 
      },
      { 
        name: 'sample_rate', 
  ...
  },
  {
    ...
    fields: [
      { 
        ...
        label: 'Protocol', 
        type: 'dropdown', 
        options: ['WiFi', 'Bluetooth', 'LoRa', 'Ethernet'], 
        required: true 
      },
      { 
        name: 'network_name', 
      ...
      { 
        ...
        type: 'dropdown', 
        options: ['Best Effort', 'Assured Forwarding', 'Expedited Forwarding'], 
      ...
      { 
        ...
        type: 'dropdown', 
        options: ['None', 'Cellular', 'Satellite', 'LoRa'], 
        defaultValue: 'None' 
      },
      { 
